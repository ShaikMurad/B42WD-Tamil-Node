...
// movies with > 8.6 |{_id:0, name:1, rating:1}
...
// exclusion
db.movies.find({ rating: { $lt: 8.5 } }, { trialer: 0, rating: 0 });
...
// movies with other than this rating - 7, 8.6, 8.8
db.movies.find(
...
//moview with rating - except for 8
